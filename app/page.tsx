  ...
  return (
    <div className="min-h-dvh bolao-splash-bg flex flex-col text-white overflow-hidden relative">
      ...
      <div className="flex-1 min-h-0 flex items-center justify-center px-5 overflow-hidden relative z-10">
        <div className="flex flex-col items-center gap-5 max-h-[52dvh]">
          <img
            src="/fifa.png"
            alt="Logo do Bolão"
          ...
          <img
            src="/write.png"
            alt="bolaowrite"
            className="w-[70vw] max-w-[300px] h-auto max-h-[17dvh] object-contain"
          />
        </div>
      </div>

      <div className="px-6 pb-9 pt-4 relative z-10">
        ...
        <div className="w-full flex justify-center">
          <div className="flex flex-col items-center">
            <GlassButton
              ...
              className="w-20 h-20 rounded-full before:rounded-full text-white touch-manipulation shadow-[0_4px_16px_rgba(16,185,129,0.35)] hover:shadow-[0_6px_20px_rgba(16,185,129,0.45)]"
            >
